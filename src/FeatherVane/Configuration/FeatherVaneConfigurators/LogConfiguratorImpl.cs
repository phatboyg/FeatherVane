...
namespace FeatherVane.FeatherVaneConfigurators
{
        ...
        VaneBuilderConfigurator<T>
    {
        ...
        public LogConfiguratorImpl()
        {
            _format = DefaultFormat;
        }

        LogConfigurator<T> LogConfigurator<T>.SetOutput(TextWriter output)
        {
            _output = output;
            return this;
        }

        LogConfigurator<T> LogConfigurator<T>.SetFormat(Func<Payload<T>, string> format)
        {
            _format = format;
            return this;
        }

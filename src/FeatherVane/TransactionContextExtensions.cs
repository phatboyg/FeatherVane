...
namespace FeatherVane
{
    ...
    public static class TransactionContextExtensions
    {
        ...
        /// <returns></returns>
        public static TransactionScope CreateTransactionScope<T>(this Payload<T> payload, TimeSpan scopeTimeout)
        {
            var context = payload.Get<TransactionContext>();

            return new TransactionScope(context.Transaction, scopeTimeout);
        }
    }
}